...
#define OS_CFG_PRIO_MAX                 32UL               /* Defines the maximum number of task priorities (see OS_PRIO data type) */
...
#define OS_CFG_STK_SIZE_MIN             64UL               /* Minimum allowable task stack size                                     */
...
#define OS_CFG_SEM_SET_EN               DEF_DISABLED       /*     Include (DEF_ENABLED) code for OSSemSet()                         */
...
#define OS_CFG_TASK_Q_EN                DEF_DISABLED       /* Include (DEF_ENABLED) code for OSTaskQXXXX()                          */
#define OS_CFG_TASK_Q_PEND_ABORT_EN     DEF_DISABLED       /* Include (DEF_ENABLED) code for OSTaskQPendAbort()                     */
#define OS_CFG_TASK_REG_TBL_SIZE        1UL                /* Number of task specific registers                                     */
#define OS_CFG_TASK_STK_REDZONE_EN      DEF_DISABLED       /* Enable (DEF_ENABLED) stack redzone                                    */
#define OS_CFG_TASK_STK_REDZONE_DEPTH   8UL                /*     Depth of the stack redzone                                        */
